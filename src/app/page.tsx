  ...
  return (
    <div className="flex flex-col w-4/5 mx-auto md:flex-row md:mb-48">
      <div className="flex flex-col w-full bg-slate-900 rounded-md p-6  md:rounded-lg md:w-1/3 mx-auto">
        ...
        <button className="rounded-full bg-cyan-500 mt-4 text-gray-100 p-2 font-semibold md:w-1/3 place-self-center hover:bg-cyan-900 hover:text-white hover:animate-bounce"><Link href="/realestate">Learn More</Link></button>
      </div>
      <div className="flex flex-col w-full bg-slate-900 rounded-md my-10 p-6 md:my-0 md:rounded-lg md:w-1/3 mx-auto">
        ...
        <button className="rounded-full bg-cyan-500 mt-4 text-gray-100 p-2 font-semibold md:w-1/3 place-self-center hover:bg-cyan-900 hover:text-white hover:animate-bounce"><Link href="/propmgmt">Learn More</Link></button>
      </div>
    </div>
  );
}
